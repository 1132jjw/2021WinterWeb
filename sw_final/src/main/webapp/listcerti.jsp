...
<body>
    ...
    <div class="row flex-nowrap">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li>
                        <a href="#submenu3" data-bs-toggle="collapse" class="nav-link px-0 align-middle">
                            ...
                            <li class="w-100">
                                <a href="listcerti.jsp" class="nav-link px-0"> <span class="d-none d-sm-inline">전체학점 확인</span></a>
                            </li>
                            <li>
                                <a href="listcommon.jsp" class="nav-link px-0"> <span class="d-none d-sm-inline">공통기초 확인</span></a>
                            </li>
                            <li>
                                <a href="listcommon.jsp" class="nav-link px-0"> <span class="d-none d-sm-inline">필수교양 확인</span></a>
                            </li>
                            <li>
                                <a href="listlective.jsp" class="nav-link px-0"> <span class="d-none d-sm-inline">누적등수 확인</span></a>
                            </li>
                            <li>
                                <a href="listlective.jsp" class="nav-link px-0"> <span class="d-none d-sm-inline">총이수학점 확인</span></a>
                            </li>
                        </ul>
                    </li>
                </ul>
		...
		<tr>
			...
			<td><%=rs.getString("threethou")%></td>
			<td><%=rs.getString("common")%></td>
