...
<div class="container px-4 py-5" id="hanging-icons">
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h2>전체학점 완료</h2>
          <p>전체 학생들은 지금까지 수강한 학점과 졸업요건들에서 완료된 부분과 미완료된 부분들을 확인합니다.</p>
          <a href="listcerti2.jsp" class="btn btn-primary">
            전체학점 완료
          </a>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h2>전체학점</h2>
          <p>졸업요건을 미완료한 학생들은 지금까지 수강한 학점과 졸업요건들을 확인할 수 있습니다.</p>
          <a href="listcerti3.jsp" class="btn btn-primary">
            전체학점
          </a>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h2>공통기초</h2>
          <p>공통기초만 따로 부족한 부분을 확인합니다.</p>
          <a href="listcommon.jsp" class="btn btn-primary">
            공통기초
          </a>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h2>필수교양</h2>
          <p>필수교양만 따로 부족한 부분을 확인합니다.</p>
          <a href="listelective.jsp" class="btn btn-primary">
            필수교양
          </a>
        </div>
      </div>
      <div class="col d-flex align-items-start">
        ...
        <div>
          <h2>누적등수</h2>
          <p>전체 학생 중에서 총이수학점과 누적된 평균학점을 비교합니다.</p>
          <a href="listrank.jsp" class="btn btn-primary">
            누적등수
          </a>
        </div>
      </div>
