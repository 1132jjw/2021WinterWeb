...
<%!// 변수 선언
	...
	String sql = "select st_id, lang, license, threethou, common, elective, (threethou+common+elective+etc) as allcredit from certi where lang=0 or license=0 or threethou<45 or common<23 or elective<39 or (threethou+common+elective+etc)<135;";%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<div class="container-fluid">
	...
	<table border="1">
		...
		<p>*외국어인증과 정보인증에서 1은 수료, 0은 미수료를 의미함.
		<%
			while (rs.next()) {
		%>
		<tr>
